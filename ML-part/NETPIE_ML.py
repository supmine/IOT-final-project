...
tflite_model_path = "./mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite" 
# Path to label map file
Labels_path = "./coco_labels.txt" # from MobileNet SSD v2 (COCO) https://coral.ai/models/?fbclid=IwAR347RorBNMeLiFZ6A_5z7UfNJ-bCZbXIsfQ81XDdkKFs7TrPt3hYmv61DI 
...
living_thing = ['person','bird','cat','dog','horse','sheep','cow','elephant','bear','zebra','giraffe']

port = 1883 # default port
Server_ip = "broker.netpie.io" 

Subscribe_Topic = "@msg/LED" #Not use
Publish_Topic = "@shadow/data/update"

Client_ID = "fadf90da-bd34-44e9-afff-279f16627589"
Token = "EjUrXaFnUGksWWssCC5C36uvgaFkrBo1"
Secret = "pptp9W~Sa8#swgcPrtVRr6DdbRgA7lZ5"
...
while True:
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            if object_name not in living_thing:
                result += object_name
    ...
    data_out=json.dumps({"data": {"object":result}}) # encode object to JSON
    print(data_out)
